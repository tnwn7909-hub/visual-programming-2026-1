...
namespace _007_MessageBox
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            DialogResult result2 = MessageBox.Show("세개의 버튼과 물음표 ... 메시지박스입니다", "Guestion", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
            ...
            string msg = string.Format("당신의 선택 : {0} {1} {2}",result1.ToString(),result2.ToString(),result3.ToString());MessageBox.Show(msg, "Your Selections");
